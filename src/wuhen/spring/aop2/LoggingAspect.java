...
public class LoggingAspect {
     ...
     */
    @Pointcut("execution(public int wuhen.spring.aop2.ArithmeticCalculator.*(..))")
    public void declareJointPointExpression(){}

    /**
     *  在wuhen.spring.aop2.ArithmeticCalculator 接口的每一个实现类的每一个方法开始之前执行一段代码
     */
    //wuhen.spring.aop2.ArithmeticCalculator的参数、方法任意
     ...
     */
     /*
    @Around("execution(public int wuhen.spring.aop2.ArithmeticCalculator.*(..))")
